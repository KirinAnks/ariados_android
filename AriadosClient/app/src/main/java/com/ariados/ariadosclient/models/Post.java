...
public class Post {
    ...
    public Post(String title, String viewers, String status, String creator_name, String text, String answer_of, String last_update) {
        this.title = title;
    ...
    public String toString() {
        return String.format("%s || [%s] [%s] by %s", this.title, this.viewers, this.status, this.creator_name);
    }
}
